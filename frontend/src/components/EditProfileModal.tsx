...
const EditProfileModal = () => {
  ...
  const [updateUserProfile, { data, loading, error }] = useMutation<UpdateUserProfileMutation>(UPDATE_PROFILE)
        ...
        return updateUserProfile({
          ...
          .then((res) => {
            setUser({
              ...
              fullname: username,
              bio: bio,
              image: res.data?.updateUserProfile.image ? res.data?.updateUserProfile.image : 'https://picsum.photos/id/83/300/320'
            })
